 ...
 */
public class PatchPinView extends AppCompatEditText {
    ...
    public PatchPinView(Context context) {
        this(context, null);
    }

    public PatchPinView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, R.attr.pinViewStyle);
    }

    public PatchPinView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = theme.obtainStyledAttributes(attrs, R.styleable.PatchPinView, defStyleAttr, 0);

        mViewType = a.getInt(R.styleable.PatchPinView_viewType1, VIEW_TYPE_RECTANGLE);
        mPinItemCount = a.getInt(R.styleable.PatchPinView_itemCount1, DEFAULT_COUNT);
        mPinItemHeight = (int) a.getDimension(R.styleable.PatchPinView_itemHeight1,
                res.getDimensionPixelSize(R.dimen.pv_pin_view_item_size));
        mPinItemWidth = (int) a.getDimension(R.styleable.PatchPinView_itemWidth1,
                res.getDimensionPixelSize(R.dimen.pv_pin_view_item_size));
        mPinItemSpacing = a.getDimensionPixelSize(R.styleable.PatchPinView_itemSpacing1,
                res.getDimensionPixelSize(R.dimen.pv_pin_view_item_spacing));
        mPinItemRadius = (int) a.getDimension(R.styleable.PatchPinView_itemRadius1, 0);
        mLineWidth = (int) a.getDimension(R.styleable.PatchPinView_lineWidth1,
                res.getDimensionPixelSize(R.dimen.pv_pin_view_item_line_width));
        mLineColor = a.getColorStateList(R.styleable.PatchPinView_lineColor1);
        isCursorVisible = a.getBoolean(R.styleable.PatchPinView_android_cursorVisible, true);
        mCursorColor = a.getColor(R.styleable.PatchPinView_cursorColor1, getCurrentTextColor());
        mCursorWidth = a.getDimensionPixelSize(R.styleable.PatchPinView_cursorWidth1,
                res.getDimensionPixelSize(R.dimen.pv_pin_view_cursor_width));

        mItemBackground = a.getDrawable(R.styleable.PatchPinView_android_itemBackground);
        mHideLineWhenFilled = a.getBoolean(R.styleable.PatchPinView_hideLineWhenFilled1, false);
