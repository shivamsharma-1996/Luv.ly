...
/**
 * Created by Shivam Sharma on 09,February,2021
 */
public class ScratchCard extends View {
    ...
    private void resolveAttr(Context context, AttributeSet attrs) {
        ...
        mScratchWidth = typedArray.getDimension(R.styleable.ScratchCard_scratchWidth, PatchCommonUtil.getInstance().dipToPx(context, 70));
        typedArray.recycle();
    }
